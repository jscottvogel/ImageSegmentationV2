...
def main():
    print("Evaluating unscaled Class 0 keep strategy...")
    for t in [0.90, 0.95, 0.99]:
        score = evaluate_c0_keep(t)
        print(f"Threshold: {t} | Score: {score:.5f}")
